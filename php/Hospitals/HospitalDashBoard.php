        ...
        <div id="AdManagement" class="section <?php echo $activeSection == 'AdManagement' ? 'active' : ''; ?>">
            ...
            <div class="container">
                <div class="row">
                    ...
                    // Modify the SQL query to join kidney transplant advertisements with the hospital table
                    $query = "SELECT ad.kidneyTransplantAdvertisementId, ad.adBanner, ad.patientName, ad.status, h.hospitalName 
                            FROM kidneyTransplantAdvertisement ad 
                            JOIN hospitals h ON ad.hospitalId = h.hospitalId";
                    $kidneyResults = mysqli_query($db, $query);
                    ...
                    <div class="col-md-6">
                        ...
                        <?php while ($ad = mysqli_fetch_assoc($kidneyResults)) { ?>
                            <div class="card mb-4">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title"><strong>Patient Name : </strong><?php echo htmlspecialchars($ad['patientName']); ?></h5>
                                    <h5 class="card-text"><strong>Hospital Name : </strong> <?php echo htmlspecialchars($ad['hospitalName']); ?></>
