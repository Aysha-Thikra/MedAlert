...
<body>
    ...
    <div class="container text-center mt-5">
        ...
        <form method="post" action="hospital_signup.php" class="mt-4">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "SELECT username,email FROM hospitals";
            $result = $db->query($sql);
            ...
            if (empty($errors)) {
                ...
                $mail->Body = "<p>Dear " . $hospitalName . ", <br> <br>Welcome to MedAlert - Your Healthcare Partner! <br> We're thrilled to have you onboard. To ensure the security of your MedAlert account, we need to verify your email address using a One Time Password (OTP).</p> <h4>Your verification OTP code is $otp </h4>
                    <br>
        ...
        ?>
                ...
                ?>
                    <script>
                        <?php
                        // Store the hospital data in session to insert after OTP verification
                        $hospital_data = array(
                        ...
                        $_SESSION['hospital_data'] = $hospital_data;
